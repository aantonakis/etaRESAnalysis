#ifndef PFP_RECO_INFO_H
#define PFP_RECO_INFO_H
...
public:
	...
	std::string shw_tag = "rec.reco.pfp.shw.";
	std::string trk_tag = "rec.reco.pfp.trk.";
	...
	std::string pfp_slcID_str = "rec.reco.pfp.slcID";
	Int_t *pfp_slcID = new Int_t[pfp_length];
	
	std::string pfp_trackScore_str = "rec.reco.pfp.trackScore";
	Float_t *pfp_trackScore = new Float_t[pfp_length];
	
	std::string pfp_id_str = "rec.reco.pfp.id";
	Int_t *pfp_id = new Int_t[pfp_length]; 
	
	std::string pfp_parent_str = "rec.reco.pfp.parent";
	Int_t *pfp_parent = new Int_t[pfp_length]; 

	std::string pfp_parent_is_primary_str = "rec.reco.pfp.parent_is_primary";
	Char_t *pfp_parent_is_primary = new Char_t[pfp_length]; 

	std::string pfp_t0_str = "rec.reco.pfp.t0";
	...
	void setPFPRecoInfoAddresses(TTree *tree) {
