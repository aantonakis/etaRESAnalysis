...
// Custom includes
#include "../include/PFPRecoInfo.h"

using namespace analysis;

//gDebug = 3;

void pfp_reco_scraper(const char* input_file, const char* output_file) {
    ...
    PFPRecoInfo pfp_info;
    pfp_info.setPFPRecoInfoAddresses(event_tree);
